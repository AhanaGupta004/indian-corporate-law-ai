"""
rag_service/main.py — Standalone FastAPI app for RAG analysis
...
from services.rag_service.router import router
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(title="LegalBuddy — RAG Service", version=settings.APP_VERSION, lifespan=lifespan)
