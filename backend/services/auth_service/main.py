"""
auth_service/main.py — Standalone FastAPI app for authentication
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(title="LegalBuddy — Auth Service", version=settings.APP_VERSION, lifespan=lifespan)
